#ifndef _MR_CPPLIB_DATABASE_H
#define _MR_CPPLIB_DATABASE_H
    ...
    class _API_ Database {
        ...
        public:
            ...
            *********************/
            ...
            inline void runExcept(const char * q) throw (mrutils::ExceptionNoSuchData) {
                if (!run(q)) throw mrutils::ExceptionNoSuchData(error);
            }

            inline void rrExcep(const char * q) throw (mrutils::ExceptionNoSuchData) {
        ...
        public:
            ...
            * assumed. 
            */
            virtual bool syncFromDump(mrutils::BufferedReader& reader, const char * table, fastdelegate::FastDelegate2<mrutils::BufferedReader&,int,bool> finishFunc = NULL) = 0;

           /**
            * Uses dump formatted as in dumpTableChangeById. only deletion
            * and addition of rows
            */
            virtual bool syncFromDumpChangeById(mrutils::BufferedReader& reader, const char * table, std::vector<int> * deletedIds = NULL, std::vector<int> * addedIds = NULL) = 0;

           /**
            * Only additions are performed. Used with dumpTableLastId
            */
            virtual bool syncFromDumpLastId(mrutils::BufferedReader& reader, const char * table, std::vector<int> * addedIds = NULL, fastdelegate::FastDelegate2<mrutils::BufferedReader&,int,bool> finishFunc = NULL) = 0;

           /**
            * Returns the new insert id
            */
            virtual int syncFromDumpInsert(mrutils::BufferedReader& reader, int key, const std::string& priName, const std::string& insertStr, const std::vector<char>& colTypes, const char * table, fastdelegate::FastDelegate2<mrutils::BufferedReader&,int,bool> finishFunc = NULL) throw (mrutils::ExceptionNoSuchData) = 0;
            virtual void syncFromDumpUpdate(mrutils::BufferedReader& reader, int key, const std::vector<std::string>& colNames, const std::vector<char>& colTypes, const char * table) throw (mrutils::ExceptionNoSuchData) = 0;
            virtual void syncFromDumpAppendString(mrutils::BufferedReader& reader, mrutils::stringstream& ss) throw (mrutils::ExceptionNoSuchData) = 0;
            ...
            */
            virtual bool dumpTable(mrutils::BufferedWriter& out, const char * table, const std::vector<std::string> * omitColumns = NULL, const char * whereClause = NULL, fastdelegate::FastDelegate2<mrutils::BufferedWriter&,int> finishFunc = NULL) = 0;
            ...
            */
            virtual bool dumpTableChangeById(mrutils::BufferedReader& reader, mrutils::BufferedWriter& out, const char * table, const std::vector<std::string> * omitColumns = NULL) = 0;
            ...
            */
            virtual bool dumpTableFromLastId(mrutils::BufferedReader& reader, mrutils::BufferedWriter& out, const char * table, const std::vector<std::string> * omitColumns = NULL, const char * whereClause = NULL, fastdelegate::FastDelegate2<mrutils::BufferedWriter&,int> finishFunc = NULL) = 0;

            static bool dumpTableReadCols(mrutils::BufferedReader& reader
                ,std::vector<char> * colTypes
                ,std::vector<std::string>* colNames
                ,std::string * priName) throw (mrutils::ExceptionNoSuchData);

            virtual bool dumpTableDesc(const char * table, std::vector<char> * colTypes, std::vector<std::string>* colNames, std::string * priName, const std::vector<std::string> * omitColumns = NULL) = 0;

        public:
            int errId; const char * error;
            bool connected;
